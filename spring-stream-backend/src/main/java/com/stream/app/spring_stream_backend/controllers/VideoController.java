...
public class VideoController {
    ...
    public ResponseEntity<?> create(
        ...
        if (savedVideo != null) {
            ...
            msg.setMessage("Video not uploaded");
    ...
    // stream videos ko chunks mein upload krne ke liye
...
//        }
    ...
    public ResponseEntity<Resource> serverSegments(
        ...
        return ResponseEntity
                .ok()
                .header(
                        HttpHeaders.CONTENT_TYPE,"video/mp2t"  //content type of hls segment
                )
                .body(resource);
    }
